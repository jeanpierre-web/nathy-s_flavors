...
function filterTable() {
    ...
    if (filter === "") {
        ...
        if (foundCount === 0) {
            resultMessage.textContent = "Aucune commande trouvé.";
        } else if (foundCount === 1) {
            resultMessage.textContent = "1 commande trouvé.";
        } else {
            resultMessage.textContent = foundCount + " commandes trouvés.";
        }
    }
}
...
function exportToExcel() {
    ...
    XLSX.writeFile(wb, "listes_commande.xlsx");
}
